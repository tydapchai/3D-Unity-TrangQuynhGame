...
using Tydapchai.FinalCharacterController;
using UnityEngine;
using UnityEngine.InputSystem;
using static Tydapchai.FinalCharacterController.PlayerState;
...
namespace Tydapchai.FinalCharacterController
{
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        private void HandleLateralMovement()
        {
            ...
            {
                _verticalVelocity = -1f; // Small downward velocity to keep grounded

                if (_playerLocomotionInput.ShouldJump)
                {
